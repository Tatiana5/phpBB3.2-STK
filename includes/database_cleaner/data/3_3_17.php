...
/**
* phpBB 3.3.17 data file
*/
class datafile_3_3_17
{
	/**
	* @var Array The bots
	*/
	...
	*/
	...
	/**
	* @var Array Config entries that were removed by the 3.3.17 update
	*/
	var $removed_config = array(
		// No config entries removed 3.3.16 -> 3.3.17
	);
	...
	*/
	var $acl_options = array(
		// No permission changes 3.3.16 -> 3.3.17
	);
	...
	*/
	var $acl_role_data = array(
		// No role data changes 3.3.16 -> 3.3.17
	);
	...
	*/
	var $extension_groups = array(
		// No extension group changes 3.3.16 -> 3.3.17
	);
	...
	*/
	var $extensions = array(
		// No extension changes 3.3.16 -> 3.3.17
	);
	...
	*/
	var $module_categories = array(
		// No Module categories changes 3.3.16 -> 3.3.17
	);

	var $module_extras = array(
		// No Module extra changes 3.3.16 -> 3.3.17
	);

	var $module_categories_basenames = array(
		// No Categories basenames changes 3.3.16 -> 3.3.17
	);
	...
	*/
	var $groups = array(
		// No Group changes 3.3.16 -> 3.3.17
	);
	/**
	* @var Array All default report reasons
	*/
	var $report_reasons = array(
		// No reason changes 3.3.16 -> 3.3.17
	);

	var $acp_modules = array(
		// No ACP modules changes 3.3.16 -> 3.3.17
	);
