...
$lang = array_merge($lang, array(
	...
	'allow_mentions'					=> 'Разрешить упоминания пользователей',
	...
	'board_disable_access'				=> 'Ограниченный доступ к отключённой конференции',
	...
	'captcha_turnstile_secret'			=> 'Секретный ключ капчи Turnstile',
	'captcha_turnstile_sitekey'			=> 'Ключ сайта капчи Turnstile',
	'captcha_turnstile_theme'			=> 'Тема виджета капчи Turnstile',
